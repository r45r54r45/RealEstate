                        ...
                        <div className="info-area">
                            ...
                            <div className="right-area">
                                <div className="top">
                                    <div>
                                        <div className="title">
                                            {currentData.type == 1 ? "전세가" : (currentData.type == 2 ? "매매가" : (currentData.type == 2 ? "보증금/월세" : "분양가/매매가"))}
                                        </div>
                                        <div className="desc">
...
function getBigPrice(item) {
    switch (item.type) {
        ...
        case 3:
            return item.b_price+'<span class="residue">만원/</span> '+item.w_price+'<span class="residue">만원 </span>';
        case 4:
